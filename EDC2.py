...
def fEDC(part, model, singlePlane, multiPlane, *args, **kwargs):
    ...
    if multiPlane == True and selectAxis == 'Or Create Own Desired Axis':
        ...
        elif axisPoints == 'Or Enter Points Manually':
    ...
    if singlePlane == True:
        ...
        elif selectPsingle == 'Or Define Points Manually:':
    ...
    if multiPlane == False and singlePlane == False:
        raise Exception('No checkboxes were ticked to perform calculations please tick one checkbox')